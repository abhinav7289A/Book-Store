...
const Navbar = () => {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all dark:bg-slate-900 dark:text-white ease-in-out" : ""}`}>
                <div className="navbar ">
                   ...
                   <div className='hidden md:block'>
                    <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                        <input type="text" className="grow outline-none bg-inherit dark:bg-slate-900 dark:text-white" placeholder="Search" />
